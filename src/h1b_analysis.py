...
#Define function input_file_sanity_check which takes file as input and sanity checks if the file exists with proper permissions
#If not , the function exits with an appropriate message.
